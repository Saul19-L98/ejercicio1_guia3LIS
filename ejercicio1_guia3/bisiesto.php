...
<html lang="es">
    <head>
        ...
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width,userscalable=no,initialscale=1.0,maximum-scale=1.0,minimum-scale=1.0" />
        ...
        <div class="wrapper">
            ...
            ?>
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" name="frmdatos">
                    ...
                    <input type="text" name="year" id="year" value="" maxlength="20"
                    placeholder="(Ingrese
                    el dato)" /><br />
            ...
            <?php
                ...
                if(($year%4 == 0 && $year%100 != 0) || $year%400 == 0):
                    ...
                    echo "<span style=\"color:Green;font:bold 10pt 'Lucida
                    Sans';\">El año $year es bisiesto</span><br />\n";
                    echo "<span style=\"color:Green;font:bold 10pt 'Lucida
                    Sans';\"><a
                    ...
                    echo "<p class=\"bisiesto\">";
                    echo "<span style=\"color:FireBrick;font:bold 10pt 'Lucida
                    Sans';\">El año $year no es bisiesto</span><br />\n";
                    echo "<span style=\"color:Green;font:bold 10pt 'Lucida
                    Sans';\"><a href=\"{$_SERVER['PHP_SELF']}\">Probar otro año</a>";
                    echo "</p>";
                endif;
                endif;
            ?>
